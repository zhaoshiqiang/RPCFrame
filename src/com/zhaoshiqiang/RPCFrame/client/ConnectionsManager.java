...
public class ConnectionsManager {
    ...
    public boolean open(IHandlerListener handlerListener) throws CallException {
        ...
        try {
            ...
            if (opened.get()){
                throw new CallException("com.zhaoshiqiang.client to " + addr + " is opened previously");
            }
            try {
    ...
    public boolean close() throws CallException {
        ...
        try {
            if (!opened.get()){
                throw new CallException("com.zhaoshiqiang.client to " + addr + " is closed previously");
            }
            for (Connection connection : connections){
                connection.close();
            }
